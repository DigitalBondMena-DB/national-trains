  ...
  contactDiv.innerHTML = `
    <div class="sidebar-cta-box">
                            ...
                            <div class="cta-contact-info">
                                <a href="https://wa.me/${whatsappNumber}" target="_blank" class="cta-contact-item">
                                    <div class="icon-box">
                                        <svg
                                ...
                                <a href="tel:${phoneNumber}" class="cta-contact-item">
                                    <div class="icon-box">
...
function insertContactBox() {
  const container = document.getElementById("articleContainer");
  const paragraphs = [...container.querySelectorAll("h2")].filter((p) => {
